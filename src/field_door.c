...
static const u8 sDoorAnimTiles_PewterSlidingSingle[] = INCBIN_U8("graphics/door_anims/pewter_sliding.4bpp");
...
static const u8 sDoorAnimPalettes_ViridianSlidingSingleBlue[] = {12, 12, 12, 12, 12, 12, 12, 12};
static const u8 sDoorAnimPalettes_ViridianSlidingSinglePurple[] = {12, 12, 12, 12, 12, 12, 12, 12};
...
static const struct DoorGraphics sDoorGraphics[] = {
    ...
    {METATILE_PewterCity_ViridianSlidingSingleBlue,         DOOR_SOUND_SLIDING, DOOR_SIZE_1x1, sDoorAnimTiles_ViridianSlidingSingleBlue, sDoorAnimPalettes_ViridianSlidingSingleBlue},
    {METATILE_PewterCity_ViridianSlidingSinglePurple,       DOOR_SOUND_SLIDING, DOOR_SIZE_1x1, sDoorAnimTiles_ViridianSlidingSinglePurple, sDoorAnimPalettes_ViridianSlidingSinglePurple},
